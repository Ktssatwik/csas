...
# Calls FastAPI endpoints and renders metrics.
# """
...
# data = get_data("/analytics/orders/average-order-value")
# avg_value = data.get("avg_order_value") if isinstance(data, dict) else None
# if avg_value is not None:
#     st.metric("Average Order Value", f"{avg_value}")


# st.subheader("Average Items per Order")
# data = get_data("/analytics/orders/average-items-per-order")
# avg_items = data.get("avg_items_per_order") if isinstance(data, dict) else None
# if avg_items is not None:
#     st.metric("Average Items per Order", f"{avg_items}")
